...
const getAnchorAndDir = (origin, w, h) => {
  const outside = 0.1; // Reduced from 0.2 to keep rays closer to viewport
  switch (origin) {
    case "top-left":
...
void main() {
  ...
  gl_FragColor  = color;
      ...
      const updatePlacement = () => {
        ...
        renderer.dpr = Math.min(window.devicePixelRatio, isMobile ? 1 : 1.5);
      ...
      // Add a resize observer for better mobile handling
      const resizeObserver = new ResizeObserver(() => {
        setTimeout(updatePlacement, 100); // Debounce for smooth transitions
      });
